        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <address>
                    ...
                    <abbr title="Phone">P:</abbr> (223) 05-57-77-75-76
                </address>
...
<footer id="footer" class="midnight-blue">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                &copy; 2018 Moon.Tous droits réservés.
                <br>
                <br>
            </div>
            <div class="col-sm-4">
                <ul class="pull-right">
                    <li>{!! link_to_route('dashboard', 'Accueil') !!}</li>
                    <li>{!! link_to_route('dashboard.contact', 'Nous contacter') !!}</li>
