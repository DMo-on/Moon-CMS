...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="{!! url(getLang() . '/admin') !!}" class="logo">Dasboard</a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p> {{ Sentinel::getUser()->first_name . ' ' . Sentinel::getUser()->last_name }} - Web Developer
                                    <small>Membre depuis Mars. 2018</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url(getLang() . '/admin/user/' . Sentinel::getUser()->id) }}" class="btn btn-default btn-flat">Profil</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/admin/logout') }}" class="btn btn-default btn-flat">Se Deconnecter</a></div>
