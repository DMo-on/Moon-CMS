...
class MenuController extends Controller
{
    ...
    public function store()
    {
        ...
        Flash::message('Le Menu a été ajouté avec succès');
    ...
    public function update($id)
    {
        ...
        Flash::message('Le Menu a été modifié avec succès');
    ...
    public function destroy($id)
    {
        if ($this->menu->hasChildItems($id)) {
            ...
            Flash::message("Il y a des sous-menus dans ce menu. Ne peut pas être supprimé!");
        ...
        $this->menu = $this->menu->find($id);
        $this->menu->delete();
        Flash::message('Le Menu a été supprimé avec succès');
