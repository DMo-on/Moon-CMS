...
class PhotoGalleryController extends Controller
{
    ...
    {
        $attributes = [
            'title' => 'Titre Gallerie Photo',
            'content' => 'Contenu Gallerie Photo',
            'is_published' => false,
        ];
    ...
    public function update($id)
    {
        try {
            ...
            Flash::message('La Gallerie Photo a été ajoutée avec succès');
    ...
    public function destroy($id)
    {
        ...
        Flash::message('La Gallerie Photo a été supprimée avec succès');
