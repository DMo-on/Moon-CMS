...
class CategoryController extends Controller
{
    ...
    public function store()
    {
        try {
            ...
            Flash::message('La Categorie a été ajoutée avec succès');
    ...
    public function update($id)
    {
        try {
            ...
            Flash::message('La Categorie a été modifiée avec succès');
    ...
    public function destroy($id)
    {
        ...
        Flash::message('La Categorie a été supprimée avec succès');
