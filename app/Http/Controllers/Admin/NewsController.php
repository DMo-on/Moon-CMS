...
class NewsController extends Controller
{
    ...
    public function store()
    {
        try {
            ...
            Flash::message('La Nouvelle a été ajoutée avec succès');
    ...
    public function update($id)
    {
        try {
            ...
            Flash::message('La Nouvelle a été modifiée avec succès');
    ...
    {
        $this->news->delete($id);
        Flash::message('La Nouvelle a été supprimée avec succès');
