...
class PageRepository extends RepositoryAbstract implements PageInterface, CrudableInterface
{
    ...
    public function create($attributes)
    {
        ...
        throw new ValidationException('La validation de la Page a échouée', $this->getErrors());
    }
    ...
    public function update($id, $attributes)
    {
        ...
        throw new ValidationException('La validation de la Catégorie a échouée', $this->getErrors());
    }
